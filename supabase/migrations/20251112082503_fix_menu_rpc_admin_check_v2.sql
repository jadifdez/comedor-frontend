/*
  ...
  1. Drops existing admin menu RPC functions
  2. Recreates them to check against administradores table
  3. Ensures only active administrators can use these functions
*/
